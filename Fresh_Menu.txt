...
local function ZXDM_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(ZXDM_fake_script)()
local function YLQA_fake_script() -- Frame.LocalScript 
...
coroutine.wrap(YLQA_fake_script)()
local function IRVC_fake_script() -- TextButton_2.LocalScript 
...
coroutine.wrap(IRVC_fake_script)()
local function UTCUBUC_fake_script() -- TextButton_3.LocalScript 
...
coroutine.wrap(UTCUBUC_fake_script)()
local function VHHWO_fake_script() -- TextButton_4.LocalScript 
...
coroutine.wrap(VHHWO_fake_script)()
local function XEBTFRT_fake_script() -- TextButton_5.LocalScript 
...
coroutine.wrap(XEBTFRT_fake_script)()
